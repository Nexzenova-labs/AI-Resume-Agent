...
class Resume(Base):
    ...
    source_type: Mapped[str] = mapped_column(String(30), default="uploaded")
    template: Mapped[str] = mapped_column(String(50), default="modern-impact")
    layout: Mapped[list] = mapped_column(json_type, default=list)
